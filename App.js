...
I18n.translations = {
  ...
  'ja-JP': {
    ...
    addSupplierFailure: '業者を追加できませんでした',
    editSupplierSuccess: '業者を変更しました',
    editSupplierFailure: '業者を変更できませんでした',
    deleteSupplierWarning: '本当に削除しますか？',
    deleteSupplierSuccess: '削除しました',
    deleteSupplierFailure: '削除できませんでした',
    deleteProductWarning: '本当に削除しますか？',
